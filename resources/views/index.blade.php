    ...
    <div class="w-full h-[768px] 2xl:w-[1280px] 2xl:h-[650px] flex items-center justify-center md:justify-start 2xl:justify-center mt-12 absolute">
        <div class="w-[390px] h-[768px] md:left-[250px] md:w-[512px] md:top-[50px] 2xl:w-[712px] 2xl:h-[370px] 2xl:top-[100px] absolute flex-col justify-start items-start gap-4 pl-5 2xl:pl-0 inline-flex">
            ...
            <p class="flex-col justify-start items-start gap-[30px] flex">
                <span class="2xl:w-[712px]"><span class="text-slate-950 text-2xl 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[30px] 2xl:leading-[60px]">Where Passion Meets </span><span class="text-orange-600 text-2xl 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[30px] 2xl:leading-[60px]">Purpose</span><span class="text-slate-950 text-2xl 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[30px] 2xl:leading-[60px]">, and </span><span class="text-blue-900 text-2xl 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[30px] 2xl:leading-[60px]">Adventures</span><span class="text-slate-950 text-2xl 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[30px] 2xl:leading-[60px]"> Unfold</span></span>
            </p>
            <p class="w-[390px] 2xl:w-[710px] text-zinc-800 text-lg font-normal font-['PP Mori'] leading-[27px]">
                There are plenty of activities and things to do when you visit Cancun, Riviera Maya or Playa del Carmen, get yourself ready to enjoy the best tours and activities in the region. Visit World Heritage Sites, famous landmarks or natural reserves in a safe, convenient and comfortable way.
            </p>
            <div class="px-[35px] py-5 bg-orange-600 rounded-[5px] justify-center items-center gap-2.5 inline-flex">
                <a class="text-white text-base font-semibold font-['PP Mori']">Get Started</a>
            </div>
        </div>
    ...
    <div class="flex-col justify-start items-start gap-10 flex">
        <div class="flex-col justify-start items-start gap-[25px] flex">
            <div class="flex-col justify-start items-start gap-[17px] px-10 2xl:px-0 flex">
                <div class="text-orange-600 text-md 2xl:text-sm font-semibold font-['PP Mori'] uppercase tracking-widest">Our Experiences</div>
                <div><span class="text-slate-950 text-[30px] 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[40px] 2xl:leading-[60px]">Your Guides to Untamed </span><span class="text-blue-900 text-[30px] 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[40px] 2xl:leading-[60px]">Experiences</span></div>
            </div>
    ...
    <div class="w-[375px] md:w-full 2xl:w-full h-[30px] absolute md:flex justify-center items-start gap-[115px] 2xl:inline-flex">
        ...
        <div class="w-[375px] 2xl:w-2/6 px-5 2xl:px-0 flex-col justify-start items-start gap-10 inline-flex">
            <div class="flex-col justify-start items-start gap-[17px] flex">
                ...
                <div class="w-[375px] 2xl:w-full"><span class="text-slate-950 text-[35px] 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[25px] 2xl:leading-[60px]">Your Guides to Untamed </span><span class="text-blue-900 text-[35px] 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[25px] 2xl:leading-[60px]">Experiences</span></div>
            </div>
            <div class="px-[35px] py-5 bg-orange-600 rounded-[5px] justify-center items-center gap-2.5 inline-flex">
                <a class="text-white text-base font-semibold font-['PP Mori']">Start Booking Now</a>
            </div>
        </div>
        ...
        <div class="w-[375px] 2xl:w-[639.67px] flex-col px-5 2xl:px-0 pt-12 md:pt-0 2xl:pt-0 justify-start items-start gap-[21px] inline-flex">
            <div class="w-[375px] 2xl:w-[639.67px] flex-col justify-start items-start gap-[15px] flex">
                <div class="w-[375px] 2xl:w-[634px] h-[54px] relative">
                    <div class="w-[375px] 2xl:w-[403px] h-[54px] left-0 top-0 absolute flex-col justify-start items-start gap-[15px] inline-flex">
                        <div class="flex-col justify-start items-start gap-[7px] flex">
                            <p class="text-slate-950 text-[25px] font-bold font-['Trip Sans']">Transfers</p>
                            <p class="text-orange-600 text-xs font-semibold font-['PP Mori'] uppercase tracking-widest">We can take care of your transportation needs</p>
                        </div>
                    </div>
                ...
                <p class="w-[375px] 2xl:w-[639.67px] text-zinc-600 text-sm font-normal font-['PP Mori'] leading-[23px]">To make your travels easier, we can take care of your transportation needs. <span>Providing you with a stress-free vacation experience, our promise is simple, we will take you quickly and efficiently from the Airport to your hotel and back if needed. Our private transportation services are often more affordable than taxis or other transportation services upon arrival. With a variety of routes and a comprehensive service area.</span>
                </p>
            </div>
                ...
                <div class="w-[375px] 2xl:w-[634px] h-[54px] relative">
                    <div class="w-[403px] h-[54px] left-0 top-0 absolute flex-col justify-start items-start gap-[15px] inline-flex">
                        <div class="w-[375px] 2xl:w-[639.67px] flex-col justify-start items-start gap-[7px] flex">
                            <p class="text-slate-950 text-[25px] font-bold font-['Trip Sans']">Experiences</p>
                            <p class="text-orange-600 text-xs font-semibold font-['PP Mori'] uppercase tracking-widest">We can take care of your transportation needs</p>
                        </div>
                    </div>
...
<div class="w-full h-[2150px] md:h-[750px] 2xl:h-[850px] relative my-12 py-12" id="reviews">
    <div class="w-full h-[152px] 2xl:h-[152px] mx flex-col justify-center items-center gap-[17px] inline-flex py-12">
        <p class="text-orange-600 text-sm font-semibold font-['PP Mori'] uppercase tracking-widest pt-12 mt-12">Testimonials</p>
        <p class="w-full 2xl:w-[775px] text-center text-slate-950 text-[30px] 2xl:text-[50px] font-bold font-['Trip Sans'] leading-[40px] 2xl:leading-[60px]">Inspiring Stories from Our Incredible Clients</p>
    </div>
